...
while(sand_still_stopping):
    ...
    while(sand_falling):
        ...
        if spot_below in stopped_stuff or spot_below[1]==max_y+2:
            spot_below_left=(sand[0]-1,sand[1]+1)
            if spot_below_left in stopped_stuff or spot_below[1]==max_y+2:
                spot_below_right=(sand[0]+1,sand[1]+1)
                if spot_below_right in stopped_stuff or spot_below[1]==max_y+2:
